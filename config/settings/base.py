...
ROOT_DIR = environ.Path(__file__) - 3  # (website/config/settings/base.py - 3 = website/)
...
LOCAL_APPS = [
    ...
    'website.website.apps.WebsiteConfig',
]
...
ADMINS = [
    ("""Vladimir Myshouski""", 'vladimirmyshkovski@gmail.com'),
]
